...
export const INITIAL_PROMPTS: PromptItem[] = [
  ...
  // --- AKADEMICKIE I BADANIA ---
  {
    id: "acad-wyniki-1",
    category: "academic",
    title: "Precyzyjne opracowanie sondaży rynkowych",
    description: "Generuje cały rozdział badawczy (Rozdział IV) w bezbłędnej, profesjonalnej nomenklaturze akademickiej.",
    prompt: "Opracuj wyniki badań sondażowych na podstawie dostarczonych danych [plik PDF lub XML]. Dla każdego pytania z osobna przygotuj opracowanie według schematu:\n\n1. Tytuł: Wykres [numer]. Odpowiedzi na pytanie nr [numer] - [Treść pytania].\n2. Podpis: 'Źródło: Opracowanie własne.'.\n3. Analiza opisowa: Tekst w stylu akademickim interpretujący dane. Wzoruj się na przykładzie: 'Pod względem poziomu wykształcenia w badanej grupie dominowały osoby posiadające dyplom studiów licencjackich lub inżynierskich (30,5%). 23,2% respondentów to studenci studiów magisterskich. 22,1% respondentów studiuje na studiach I stopnia. Z kolei 20% badanych posiada dyplom magistra. Nieznaczna liczba badanych posiada wykształcenie średnie.'.\n\nDbaj o płynność narracji, poprawne zaokrąglenia i naukowe słownictwo.\n\nStruktura rozdziału:\nRozdział IV: Wyniki badań własnych \n4.1. Charakterystyka społeczno-demograficzna respondentów\n4.2. Analiza wyników badań własnych \n4.3. Wnioski i rekomendacje\n\nW tym rozdziale autor pracy powinien przedstawić wnioski z badań. Na początku rozdziału opisuje szczegółowo przeprowadzone badania. Następnie podsumowuje wyniki przeprowadzonych badań (ankiet lub/i wywiadów pogłębionych, obserwacji uczestniczących). Rozdział powinien zawierać własne przemyślenia studenta związane z tematem pracy i wynikiem przeprowadzonych badań.\n\nZałożenia dla badań własnych (odnieś się we wnioskach i rekomendacjach): (wklej tu metodologię).",
    tip: "Przeklej surowe dane Excel lub kwestionariusza, a oszczędzisz całe dnie żmudnej pracy."
  },
  {
    id: "acad-sim-1",
    category: "academic",
